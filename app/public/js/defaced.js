    ...
    $.ajax({
        ...
        success: function(success) {
            ...
            if (success.Result == null) {
                ...
                success.Result !== null &&
                success.Result.ErrorMessage == "Failed" &&
                success.Result.ID <= 70
            ) {
                swal({
                    title: "Registration Failure",
                    text:
                        "Registration failed to complete with a score of " +
                        Math.floor(success.Result.ID) +
                        "%",
                    icon: "error",
                    button: "OK"
                }).then(() => {
