$(document).ready(function () {
    document
        ...
        .addEventListener("click", function (e) {
            ...
            $("#registerBulkForm").addClass("whirl traditional");

            $.ajax({
                url: "/one-sim/bulk/new-reg-post",
                type: "POST",
                data: $("#registerBulkForm").serialize(),
                success: function (success) {
                    $("#registerBulkForm").removeClass("whirl traditional");
