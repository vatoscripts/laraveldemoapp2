$(document).ready(function () {
    document
        .querySelector("#oneSIMPrimarySubmitICAP")
        .addEventListener("click", function (e) {
            ...
            $("#PrimarySIMICAPForm").addClass("whirl traditional");

            $.ajax({
                url: "/primary-sim-second-post",
                type: "POST",
                data: $("#PrimarySIMICAPForm").serialize(),
                success: function (success) {
                    $("#PrimarySIMICAPForm").removeClass("whirl traditional");
