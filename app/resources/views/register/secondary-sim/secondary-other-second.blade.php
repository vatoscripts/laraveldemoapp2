    ...
    <section class="section-container">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-heading">
                <h3>Select Number to set as secondary
                        ...
                        <div class="card b">
                            <div class="card-body">
                                <div id="AgentNIDA" class="modal-body p-3">
                                    <form method="post" action="{{ action('KYCController@setSecondaryMsisdnOther') }}" class="mb-3" id="setSecondaryMsisdnOtherForm" novalidate>
                                        @csrf

                                        <input type="hidden" name="customerID" value="{{ $ID }}">

                                        <div class="form-group">
                                            <label class="font-weight-bold mb-4">Select Customer Category </label>

                                            <div class="form-row mb-4" id='categoryCodeList'>

                                                <div class="col-3">
                                                    <label class="radio-inline">
                                                    <input class="mr-2" type="radio" name="categoryCode" value="2030"> Visitor</label>
                                                </div>
                                                <div class="col-3">
                                                    <label class="radio-inline">
                                                    <input class="mr-2" type="radio" name="categoryCode" value="2050"> Diplomat</label>
                                                </div>
                                                <div class="col-3">
                                                    <label class="radio-inline">
                                                    <input class="mr-2" type="radio" name="categoryCode" value="2060"> Defaced</label>
                                                </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="form-row" id='secondaryMSISDNList'>
                                        ...
                                        <div class="modal-footer">
                                            <button id="setSecondaryMsisdnOtherBtn" type="submit" class="btn btn-primary"><span class="fa fa-save"></span> Confirm</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
@section('scripts')
    ...
    <script src="{{ asset('js/one-sim/other/set-secondary.js') }}"></script>
