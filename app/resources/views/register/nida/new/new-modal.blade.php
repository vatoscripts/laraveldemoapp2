...
<div class="modal fade" data-keyboard="false" data-backdrop="static" id="new-customer-register" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header alert-danger" style="height:40px;"> NEW CUSTOMER REGISTRATION
            ...
            <div id="RegisterNewMSISDN" class="modal-body p-3">
                <form method="post" action="{{ action('KYCController@register_new_MSISDN_Icap') }}" class="mb-3" id="registerNewMSISDNForm" novalidate>
                    @csrf
                    ...
                    <div class="modal-footer">
                        ...
                        <button id="registerNewMSISDNBtn" type="submit" class="btn btn-primary"><span class="fa fa-save"></span> Register</button>
                    </div>
                </form>
            </div>
