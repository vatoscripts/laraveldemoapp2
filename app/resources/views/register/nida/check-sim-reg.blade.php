            ...
            <!-- START cards box-->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        ...
                        <div class="card b">
                            <div class="card-body">
                                <form method="post" action="{{ action('KYCController@getSIMRegStatus') }}" id="checkMsisdnDetailsForm" novalidate>
                                    @csrf
                                    <div class="form-group">
                                        <div class="input-group with-focus mb-2">
                                            ...
                                            <div class="input-group-append">
                                                <button id="checkMsisdnDetailsBtn" class="btn btn-block btn-info" type="submit">
...
@section('scripts')
    ...
    <script src="{{ asset('js/check-msisdn.js') }}"></script>
